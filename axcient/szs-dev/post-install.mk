post-install:
	...
	${MV} ${STAGEDIR}${PREFIX}/bin/exports ${STAGEDIR}${PREFIX}/bin/szs-op-exports
	...
	${INSTALL_DATA} ${WRKSRC}/freebsd-pkg/usr/local/etc/newsyslog.conf.d/szs_exports.conf ${STAGEDIR}${EXAMPLESDIR}/newsyslog.conf.d/
