post-install:
	...
	${MV} ${STAGEDIR}${PREFIX}/bin/cli ${STAGEDIR}${PREFIX}/bin/dralserver-cli
	${MV} ${STAGEDIR}${PREFIX}/bin/cleanupdralclones ${STAGEDIR}${PREFIX}/bin/dralserver-cleanup-clones
	${MV} ${STAGEDIR}${PREFIX}/bin/cleanupdralftpsexports ${STAGEDIR}${PREFIX}/bin/dralserver-cleanup-ftps-exports
	${INSTALL_DATA} ${WRKSRC}/build/freebsd-pkg/usr/local/etc/cron.d/dralserver-cleanup-clones ${STAGEDIR}${EXAMPLESDIR}/cron.d/
	${INSTALL_DATA} ${WRKSRC}/build/freebsd-pkg/usr/local/etc/cron.d/dralserver-cleanup-ftps-exports ${STAGEDIR}${EXAMPLESDIR}/cron.d/
	...
	${INSTALL_DATA} ${WRKSRC}/build/freebsd-pkg/usr/local/etc/newsyslog.conf.d/dralserver-cleanup-ftps-exports.conf ${STAGEDIR}${EXAMPLESDIR}/newsyslog.conf.d
	...
	${INSTALL_DATA} ${WRKSRC}/build/freebsd-pkg/usr/local/etc/rsyslog.d/dralserver-cleanup-ftps-exports.conf ${STAGEDIR}${EXAMPLESDIR}/rsyslog.d
