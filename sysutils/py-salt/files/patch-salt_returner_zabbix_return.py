--- salt/returner/zabbix_return.py	2022-08-04 16:28:27.179025000 +0000
+++ salt/returner/zabbix_return.py	2022-08-04 16:28:22.516160000 +0000
@@ -1,71 +1,149 @@
 """
...
-        return {"sender": zabbix_sender, "config": zabbix_config}
-    elif os.path.exists("/usr/local/bin/zabbix_sender") and os.path.exists(
